        ...
        <span className="relative inline-block duration-300 ease-in-out transition-transform transform hover:-translate-y-2 w-full">
          <div className="shadow p-4 rounded-lg bg-white">
            <div className="flex justify-center relative rounded-lg overflow-hidden h-52">
              ...
              <span className="absolute top-0 left-0 inline-flex mt-3 ml-3 px-3 py-2 rounded-lg z-10 bg-[#8B942C] text-sm font-medium text-white select-none">
                Featured
              </span>
            </div>
            ...
            <div className="grid grid-cols-2 grid-rows-2 gap-4 mt-8">
              <p className="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                ...
                <span className="mt-2 xl:mt-0">{book.pageCount}</span>
              </p>
              <p className="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                <svg
                  className="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-gray-800"
                ...
                <span className="mt-2 xl:mt-0">{book.format}</span>
              </p>
              <p className="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                <svg
                  className="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-gray-800"
                ...
                <span className="mt-2 xl:mt-0">{book.genre}</span>
              </p>
              <p className="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                <svg
                  className="inline-block w-5 h-5 xl:w-4 xl:h-4 mr-3 fill-current text-gray-800"
                ...
                <span className="mt-2 xl:mt-0">{book.soldCopies}</span>
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 mt-8">
              <div className="flex items-center">
                ...
                <p className="ml-2 text-gray-800 line-clamp-1">{book.Author}</p>
              </div>
